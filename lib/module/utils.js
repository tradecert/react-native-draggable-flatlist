...
import { findNodeHandle as reactNativeFindNodeHandle, Platform } from "react-native"; // Fixes bug with useMemo + generic types:
...
export function findNodeHandle(ref) {
  if (Platform.OS === "web") {
    return ref && typeof ref === "object" && "current" in ref ? ref.current : ref;
  }
